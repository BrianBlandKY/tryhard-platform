...
import (
	...
	mess "tryhard-platform/src/messenger"
	"tryhard-platform/src/model"
)
...
func (s *ConnectionService) handler(n *mess.Node) {
...
func (s *ConnectionService) processor() {
...
func newConnectionService(cfg config.Config) (s ConnectionService) {
	s = ConnectionService{
